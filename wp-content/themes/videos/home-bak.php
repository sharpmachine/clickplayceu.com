		...
		<div id="channels-inside">
			...
			<?php 
				...
				<div class="post-image-home">
						...
						$str = get_the_excerpt(); 
								...
								foreach((get_the_category()) as $category) { 
									if (cat_is_ancestor_of(14, $category->cat_ID))  { 
										if (count(get_the_category()) === $count) {
					...
					?>
					<a class="post-frame-channel <?php the_ID(); ?> tooltip" href="<?php the_permalink(); ?>" title="<?php echo $tooltip ?>"></a>
						...
						<ul>
							...
							<li><?php 
								...
								$delim = '... <a class="tooltip" href="'.get_permalink().'" title="'.$tooltip.'">Read More</a>';
						   		$len = strlen($str);
								if ($len > $n) {
							...
							<li>Credits: <?php echo get_post_meta(get_post_meta($id, 'ProductID', true), 'Credits', true); ?></li>
							<?php 
