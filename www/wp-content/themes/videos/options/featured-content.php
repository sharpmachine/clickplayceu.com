...
<div class="postbox">
    <h3>Featured Content Carousel (Home Page)</h3>
    
    <div class="inside">
    	<p>Select a category below for which you wish to display featured videos within the Featured Content Carousel on the home page.</p>
